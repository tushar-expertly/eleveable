    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            Content on the Eleveable website may be protected by U.S. and
          ...
          <p className="mb-4">
            This website provides information for visitor convenience. Eleveable
            strives for accuracy but cannot guarantee the reliability of
            third-party information. Eleveable is not responsible for actions
            taken based on this information or for any resulting consequences.
          </p>
          {/* <p className="mb-4">External Links</p> */}
          <p className="mb-4">
            Eleveable’s website may include links to external sites maintained
            ...
            endorsement by Eleveable. Links may be removed or updated at any
            time without notice.
          </p>
          <p className="font-semibold mb-2">External Links</p>
          <p className="mb-4">
            If issues arise with linked external sites, please contact the
            respective organizations. Eleveable is not responsible for the
