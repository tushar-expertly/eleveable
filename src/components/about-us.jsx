          ...
          <div className="max-w-8xl w-full space-y-8">
            <div className="bg-gray-100 shadow-md rounded-lg p-8">
              <div className="space-y-6">
                ...
                <div>
                  <h4 className=" text-gray-800">About Eleveable</h4>
                  <p className="mt-2 text-gray-600">
                    Welcome to Eleveable, where knowledge meets innovation.
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600">
                    Eleveable was born out of a shared vision to revolutionize
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600">
                    When you choose Eleveable, you're not just investing in a
