            ...
            <dl className="space-y-12 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-12 md:gap-y-12">
              <div className="relative bg-white p-6 rounded-lg shadow-lg">
                ...
                <dd className="text-base text-gray-600">
                  Welcome to Eleveable, your partner in lifelong learning. We're
                  dedicated to providing accessible, high-quality online
              ...
              <div className="relative bg-white p-6 rounded-lg shadow-lg">
                ...
                <dd className="text-base text-gray-600">
                  When you choose Eleveable, you're not just enrolling in a
