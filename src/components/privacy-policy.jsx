    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            At Eleveable, we are dedicated to safeguarding your privacy and
            ...
            existing agreements directly established between you and Eleveable.
          ...
          <p className="mb-4">
            At Eleveable, we will only request personal information when it is
          ...
          <p className="mb-4">
            In the event that Eleveable invites you to complete and submit an
          ...
          <p className="mb-4">
            It's important to note that while Eleveable may track a visitor's
          ...
          <p className="mb-4">
            The purposes for which Eleveable may utilize your personal
          ...
          <p className="mb-4">
            If you wish to be removed from any Eleveable distribution list,
          ...
          <p className="mb-4">
            ...
            Eleveable, you may receive telephone calls from us regarding new
          ...
          <p className="mb-4">
            The Eleveable website may contain links to external websites,
            ...
            are not governed by Eleveable's privacy policy. Eleveable has no
          ...
          <p className="mb-4">
            ...
            Eleveable's privacy practices and does not extend to the privacy
            policies or practices of third-party websites or features. Eleveable
          ...
          <p className="mb-4">
            ...
            paramount at Eleveable. We have implemented robust measures to
          ...
          <p className="mb-4">
            At Eleveable, we remain committed to upholding the highest standards
          ...
          <p className="mb-4">
            ...
            Eleveable remains fully compliant with the EU-US Privacy Shield
          ...
          <p className="mb-4">
            At Eleveable, we are committed to maintaining the highest standards
          ...
          <p className="mb-4">
            Eleveable is mandated to adhere to specific procedures when
          ...
          <p className="mb-4">
            In accordance with the Privacy Shield Principles, Eleveable is
          ...
          <p className="mb-4">
            Eleveable is subject to the investigative and enforcement authority
          ...
          <p className="mb-4">
            Eleveable reserves the right to modify or supplement this Privacy
            Policy at its discretion. We encourage you to periodically review
            this section of Eleveable’s website to stay informed of any updates.
